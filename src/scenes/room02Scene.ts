...
class room02Scene extends Phaser.Scene {
    ...
    create() {
        this.scene.bringToTop("room02Scene");
        const map = this.make.tilemap({ key: "room02" });
        ...
        if (tileset) {
            ...
            this.chestZone = this.add.zone(235, 200, 50, 40);
        ...
        if (this.input.keyboard) {
            this.input.keyboard.on("keydown-E", () => {
                ...
                if (
                    ...
                    this.gameState.player.health = 6; //increasing player health by one
                    this.gameState.player.hearts = 6;
